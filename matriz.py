...
class Matriz(object):
    ...
    def llenarmatrizA(self):
        for f in range(self.filas):
            for c in range(self.columnas):
                self.matriz[f][c] = random.randint(0, 15) #int(raw_input("ingrese %d, %d: " % (f, c)))
        return self.matriz
    ...
    def determinate(self, b):

        if (self.filas != self.columnas):
            print "no se encuentra el determinante, la matriz no es cuadrada "
            return True
        elif self.filas == 2:
                a = 1
                b = 1
    ...
    def elevada(self):
        ...
        if a == 2:
            ...
            print "Matriz Elevada a la Potencia: " + str(a) + '\n' + b
    ...
    def identidad(self):
        ...
        if (self.filas != self.columnas):
            print "no se puede encontrar la matriz identica"
    ...
    def multiplicacion(self, filasA, columnasB, filasB,columnasA,matrizA,matrizB):
    ...
    def resta(self, filasA, columnasB, filasB, columnasA, matrizA, matrizB):
    ...
    def suma(self, filasA, columnasB, filasB,columnasA,matrizA,matrizB):
